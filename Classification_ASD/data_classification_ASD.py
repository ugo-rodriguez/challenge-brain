...
class BrainIBISDatasetforClassificationASD(Dataset):
    def __init__(self,df,path_data,path_ico,transform = None,version=None, column_subject_id='Subject_ID', column_age='Age', column_hemisphere='Hemisphere',column_ASD = 'ASD_administered'):
        self.df = df
...
class BrainIBISDataModuleforClassificationASD(pl.LightningDataModule):
    ...
    def setup(self,stage=None):
        ...
        self.train_dataset = BrainIBISDatasetforClassificationASD(df_train,self.path_data,self.path_ico,self.train_transform)
        self.val_dataset = BrainIBISDatasetforClassificationASD(df_val,self.path_data,self.path_ico,self.val_and_test_transform)
        self.test_dataset = BrainIBISDatasetforClassificationASD(df_test,self.path_data,self.path_ico,self.val_and_test_transform)
